/**
 * Password Toggle Functionality (Alternative version with text symbols)
...
function addPasswordToggle(passwordInput) {
    ...
    toggleBtn.innerHTML = '●●●'; // Dots representing hidden password
...
function togglePasswordVisibility(passwordInput, toggleBtn) {
    ...
    if (isPassword) {
        ...
        toggleBtn.innerHTML = 'ABC'; // Text representing visible password
